    ...
    <div class="group-input">
        <div>
            ...
            <div class="in nom">
                ...
                <input type="text" name="nom" value="<?=$dataA['nom']?>" placeholder="Nom admin" autocomplete="off" id="nom" class="put anime">
            </div>
        </div>
    ...
    <div class="group-input">
        <div>
            ...
            <div class="in email">
                ...
                <input type="text" name="email" value="<?=$dataA['email']?>" placeholder="Email admin" autocomplete="off" id="email" class="put anime">
            </div>
        </div>
    
    </div>
    <div class="group-input" style="width: 100px;margin-top: 10px;">
        <div class="valider-profil">
